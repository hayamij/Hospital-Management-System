...
import { UpdatePatientProfileUseCase } from '../../../../server/application/use-cases/patient/updatePatientProfile.usecase.js';
...
wrapLegacyRun(run, 'updatePatientProfile.usecase');
