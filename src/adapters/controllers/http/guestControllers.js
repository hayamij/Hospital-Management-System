...
export function buildGuestControllers({ browsePublicInfoUseCase, guestSearchDoctorsUseCase, startRegistrationUseCase, submitContactFormUseCase, viewAvailableSlotsUseCase }) {
  return {
